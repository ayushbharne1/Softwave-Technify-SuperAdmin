...
import { fetchCommissionAgents,updateAdjustment,lockAgent } from "../../../redux/slice/commisionManagement/commisionSlice";
...
export default function CommissionManagement() {
  ...
  if (loading) return <span className="text-center mt-10">
    <LoaderSpinner/>
  </span>;
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="text-[15px] flex items-center gap-2 text-sm text-blue-100 mt-2">
          <NavLink
            to="/dashboard"
          ...
          <table className="w-full text-sm">
            <thead className="bg-[#1d476e33] sticky top-0 z-10">
              <tr className="text-black uppercase text-sm tracking-wider">
                ...
                <th className="p-4 text-center font-medium">Commission / Lead</th>
                <th className="p-4 text-center font-medium">Total Commission</th>
